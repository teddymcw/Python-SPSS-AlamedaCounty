...
*pushbreak.
 * get file='//covenas/decisionsupport/meinzer/temp/AdultHospital_EpisodesCooked_LOS.sav'.
 * SAVE TRANSLATE /TYPE=ODBC
 ...
 /table= 'AdultHospital_EpisodesCooked_LOS' /MAP/REPLACE .
*pushbreak.
...
*pushbreak.
*get file='//covenas/decisionsupport/meinzer/temp/adulthospwork_2.sav'.

 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UImD=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'AdultHospital_LatentRecid' /MAP/REPLACE.
*pushbreak.
...
*pushbreak.
 * get file='//covenas/decisionsupport/meinzer/temp/AdultHospital_AcuteAuthorization.sav'.

 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'AdultHospital_AcuteAuthorization' /MAP/REPLACE .
*pushbreak.
...
*pushbreak.
 * get file ='//covenas/decisionsupport/temp/NoLatencyCareDetailAdultHosp.sav'.

 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'AdultHospital_NoLatencyCareDetail' /MAP/REPLACE.
*pushbreak.
...
*pushbreak.
 * get file='//covenas/decisionsupport/temp/topgraph.sav'.
 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'AdultHospital_HospDays_Admits_Discharge' /MAP/REPLACE.
*pushbreak.
...
*pushbreak.
*get file='//covenas/decisionsupport/meinzer/temp/adulthosfollowupru.sav'.

*SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=DashboardDatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=DashboardDatadev;Trusted_Connection=Yes'
 /table= 'AdultHosp_FollowUpRus' /MAP/REPLACE.
*pushbreak.
...
*pushbreak.
*get file='//covenas/decisionsupport/meinzer/temp/adulthosfollowuprudetailx.sav'.

*SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=DashboardDatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=DashboardDatadev;Trusted_Connection=Yes'
 /table= 'AdultHosp_FollowUpCareDetail' /MAP/REPLACE.
*pushbreak.
...
*pushbreak.
*do not push.
 * get file='//covenas/decisionsupport/temp/adult_Svcsx.sav'.
 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=DashboardData;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=DashboardData;Trusted_Connection=Yes'
 /table= 'adult_allSVCSforLastSvc90Clients' /MAP/REPLACE.


*pushbreak.
 * get file='//covenas/decisionsupport/temp/GlobalHospEps.sav'.
 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'adult_EpsforLastSvc90Clients' /MAP/REPLACE.

*pushbreak.
*get file='//covenas/decisionsupport/TermsAndDefinitionsForEmanio.sav'.
 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'CSOCTerms' /MAP/REPLACE.
*pushbreak. 
