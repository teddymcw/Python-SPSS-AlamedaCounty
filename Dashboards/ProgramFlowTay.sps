...
!ENDDEFINE.
define PFkeepRU() '81931','81441','81442','88036','01101','01D81','01E81','01GF1','01GG1','018435','01FH1','01FK1','01FK2','81935','01ES1','01E31' 
!ENDDEFINE.
 ...
 *   SAVE TRANSLATE /TYPE=ODBC
 ...
 /table= 'ProgramFlow_admitDCOpeneps' /MAP/append.
*pushbreak.
 ...
 *     SAVE TRANSLATE /TYPE=ODBC
    /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
    ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'ProgramFlow_BubbleInandSystemCost' /MAP/append.
*pushbreak.
 ...
 *   SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'ProgramFlow_AvePerClientProgramFlow' /MAP/append.
*pushbreak.
 ...
 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'ProgramFlow_MCSvccat' /MAP/append.
*pushbreak.
 ...
 *   SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'ProgramFlow_LOSTIS' /MAP/append.
*pushbreak.
 ...
 *     SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'ProgramFlow_programflowDaysBetweenVisits' /MAP/append.
*pushbreak.
 ...
 *     SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'ProgramFlow_rusPreandPostList' /MAP/append.
*pushbreak.
 ...
 *     SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'ProgramFlow_Programflow_PrePost' /MAP/append.
*pushbreak.
