...
temp.
select if opdate lt date.dmy(1,1,2001) and ((closdate) ge date.dmy(1,1,2000) or closdate lt date.dmy(1,1,1900)).
...
temp.
select if opdate lt date.dmy(1,1,2002) and ((closdate) ge date.dmy(1,1,2001) or closdate lt date.dmy(1,1,1900)).
...
temp.
select if opdate lt date.dmy(1,1,2003) and ((closdate) ge date.dmy(1,1,2002) or closdate lt date.dmy(1,1,1900)).
...
temp.
select if opdate lt date.dmy(1,1,2004) and ((closdate) ge date.dmy(1,1,2003) or closdate lt date.dmy(1,1,1900)).
...
temp.
select if opdate lt date.dmy(1,1,2005) and ((closdate) ge date.dmy(1,1,2004) or closdate lt date.dmy(1,1,1900)).
...
temp.
select if opdate lt date.dmy(1,1,2006) and ((closdate) ge date.dmy(1,1,2005) or closdate lt date.dmy(1,1,1900)).
...
temp.
select if opdate lt date.dmy(1,1,2007) and ((closdate) ge date.dmy(1,1,2006) or closdate lt date.dmy(1,1,1900)).
...
temp.
select if opdate lt date.dmy(1,1,2008) and ((closdate) ge date.dmy(1,1,2007) or closdate lt date.dmy(1,1,1900)).
...
temp.
select if opdate lt date.dmy(1,1,2009) and ((closdate) ge date.dmy(1,1,2008) or closdate lt date.dmy(1,1,1900)).
...
temp.
select if opdate lt date.dmy(1,1,2010) and ((closdate) ge date.dmy(1,1,2009) or closdate lt date.dmy(1,1,1900)).
...
temp.
select if opdate lt date.dmy(1,1,2011) and ((closdate) ge date.dmy(1,1,2010) or closdate lt date.dmy(1,1,1900)).
...
temp.
select if opdate lt date.dmy(1,1,2012) and ((closdate) ge date.dmy(1,1,2011) or closdate lt date.dmy(1,1,1900)).
...
temp.
select if opdate lt date.dmy(1,1,2013) and ((closdate) ge date.dmy(1,1,2012) or closdate lt date.dmy(1,1,1900)).
...
temp.
select if opdate lt date.dmy(1,1,2014) and ((closdate) ge date.dmy(1,1,2013) or closdate lt date.dmy(1,1,1900)).
...
'TRIED_FINANCIAL_RESPONSIBILITY as tfinresp, FINANCIAL_RESPONSIBILITY as finresp, ACTUAL_FINANCIAL_RESPONSIBILITY as fin_resp FROM CG_Snappers.dbo.[DIRECT_SERVICES]'+
 ' WHERE SERVICE_DATE >= {ts ''2008-01-01 00:00:00''} AND SERVICE_DATE < {ts ''2011-01-01 00:00:00''} order by reporting_unit   '
 /ASSUMEDSTRWIDTH=255.
