 ...
 * SAVE TRANSLATE /TYPE=ODBC
 ...
 /table= 'Older_Adult_AdmitDCCaselistByFY' /MAP/REPLACE.
*pushbreak.
 ...
 *SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'Older_Adult_FollowUpEps' /MAP/REPLACE.
*pushbreak.
...
*pushbreak.
*get file='//covenas/decisionsupport/temp/Older_AdultFollowupRUs.sav'. 

*SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'Older_Adult_FollowUpRUs' /MAP/REPLACE.
*pushbreak.
**********************services.
get file='//covenas/decisionsupport/dbsvc.sav' /keep agency provname ru case opdate closdate proced svcdate cost calendar duration psmask2 MCsvcCat svcMode PrimaryTherapist staff proclong epflag.
...
*pushbreak.
 * get file='//covenas/decisionsupport/meinzer/temp/MonthlygoalsMatched1.sav'.

 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_GoalsFY' /MAP/REPLACE.
*pushbreak.
...
*pushbreak.
*get file='//covenas/decisionsupport/meinzer/temp/olderadult_MainLineGraphs.sav'.
 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_GoalsMonthly' /MAP/REPLACE.
*pushbreak.
*per month eps.
...
*pushbreak.
*get file='//covenas/decisionsupport/meinzer/temp/MonthlygoalsMatchedxx.sav'. 
 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_AdmitsDischarges' /MAP/REPLACE.
*pushbreak.
****************demographs.
...
save outfile='//covenas/decisionsupport/meinzer/temp/OAAgegroupShelledAGG'.
*pushbreak.
*get file='//covenas/decisionsupport/meinzer/temp/OAAgegroupShelledAGG'.
 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_Demographics_Agegroup' /MAP/REPLACE.
*pushbreak.
get file='//covenas/decisionsupport/meinzer/temp/oaonly.sav'.
aggregate outfile=*
...
*pushbreak.
*get file='//covenas/decisionsupport/meinzer/temp/OAEthnicityShelled.sav'.
 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_Demographics_Ethnicity' /MAP/REPLACE.
*pushbreak.
...
*pushbreak.
 * get file='//covenas/decisionsupport/meinzer/temp/OAgender.sav'.
 *  SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_Demographics' /MAP/REPLACE.
*pushbreak.
...
*pushbreak.
 * get file='//covenas/decisionsupport/meinzer/temp/MonthlygoalsMatchedxxxx.sav'. 
*the next line keeps this from going into the push file automatically.
*old push.
 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=DashboardData;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=DashboardData;Trusted_Connection=Yes'
 /table= 'OlderAdult_RunTot_McSvcCat' /MAP/REPLACE.
*pushbreak.
**************last svc in 90 days.
...
*pushbreak.
*get file='//covenas/decisionsupport/meinzer/temp/olderadult_NoSvc90ru.sav'.
 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_NoLastSvc90RU' /MAP/REPLACE.
*pushbreak.
...
*pushbreak.
*get file='//covenas/decisionsupport/temp/clientlistolderadult.sav'.

 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_LastSvc90Clients' /MAP/REPLACE.
*pushbreak.
...
*pushbreak.
*get file='//covenas/decisionsupport/temp\OlderAdultSvcs.sav'.

 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=Dashboarddatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=Dashboarddatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_allSVCSforLastSvc90Clients' /MAP/REPLACE.
*pushbreak.
...
*pushbreak.
 * get file='//covenas/decisionsupport/temp\EpsOlderAdult.sav'.

 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=DashboardDatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=DashboardDatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_EpsforLastSvc90Clients' /MAP/REPLACE.
*pushbreak.
*********************LOS.
get file='//covenas/decisionsupport/meinzer/temp/oalos.sav'.
insert file='//covenas/decisionsupport/modules/uncookedmonth.sps'.
...
sort cases by ru.
match files /table='//covenas/decisionsupport/rutable.sav'  /file=* /by ru /keep case opdate primdx provname LOSMonths ru los tis counter fiscalyear uncookedmonth closdate PrimaryTherapist.
...
TIS counter FiscalYear UnCookedMonth closdate PrimaryTherapist Bday name.
rename vars name=ClientName.
...
*pushbreak.
 * get file='//covenas/decisionsupport/temp/OA_loslistwithdx.sav'.

 *  SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=DashboardDatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=DashboardDatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_LOSListwithDX' /MAP/REPLACE.
*pushbreak.
...
counter TISmonthsNow Countyears Endfy TISmonths TIS FiscalYear PrimaryTherapist Bday name.
rename vars name=ClientName.
compute CurrentAge=datedif($time,bday,'years').
...
*pushbreak.
 *   get file='//covenas/decisionsupport/temp/OATISListwithDX.sav'.
 *  SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=DashboardDatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=DashboardDatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_TISListwithDX' /MAP/REPLACE.
*pushbreak.
...
*pushbreak.
*get file='//covenas/decisionsupport/meinzer/temp/OALOSShell.sav'. 

 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=DashboardDatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=DashboardDatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_LOS' /MAP/REPLACE.
*pushbreak.
...
*pushbreak.
 * get file='//covenas/decisionsupport/meinzer/temp/OATISpastandpresentShell.sav'. 
 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=DashboardDatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=DashboardDatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_TIS' /MAP/REPLACE.
*pushbreak.
...
keepEpOlderAdult ru opdate closdate epflag PrimaryTherapist UnCookedMonth counter dx dx_descr.
rename vars dx=primdx.
save outfile='//covenas/decisionsupport/meinzer/temp/OlderAdult_ClientListEps.sav'.
*pushbreak.
  *get file='//covenas/decisionsupport/meinzer/temp/OlderAdult_ClientListEps.sav'.
 *SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=DashboardDatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=DashboardDatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_ClientList_Eps' /MAP/REPLACE.
*pushbreak.
...
*pushbreak.
 * get file='//covenas/decisionsupport/meinzer/temp/OlderAdult_ClientListSVC.sav'.
 * SAVE TRANSLATE /TYPE=ODBC
 /Connect ='DSN=DashboardDatadev;UID=;APP=SPSS For'+
 ' Windows;WSID=HPMXL9360ZDD;DATABASE=DashboardDatadev;Trusted_Connection=Yes'
 /table= 'OlderAdult_ClientListSVC' /MAP/REPLACE.
*pushbreak.
