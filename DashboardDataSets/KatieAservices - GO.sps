...
*sort cases by case.
*Match files /table='//covenas/decisionsupport/clinfo.sav' /file=* /by case. 
...
get file = '//covenas/decisionsupport/temp/DBSVC.sav'.
 ...
 * match files /table='//covenas/decisionsupport/rutable.sav' /file=* /by ru /keep
...
match files /file=* /by service_stamp /first= service_stamp1.
select if service_stamp1=1. 

If ValidSvc = 1 ValidSvcTime= duration.
If ValidSvc = 0 InvalidSvcTime= duration.

select if case ne 99.
...
Save outfile ='//covenas/decisionsupport/Orozco/Temp/KatieA_ActiveProviders.sav'. 
get file = '//covenas/decisionsupport/Orozco/Temp/KatieA_ActiveProviders.sav'. 
