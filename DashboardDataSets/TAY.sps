...
*pushbreak.
*sqlTable = 'TAY_AdmitDCCaselistByFY'.
*spsstable='//covenas/decisionsupport/temp/admitDCcaselistTay.sav'.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_FollowUpEps'.
*spsstable='//covenas/decisionsupport/temp/TayFollowupSVcs.sav'.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_FollowUpRUs'.
*spsstable='//covenas/decisionsupport/temp/TayFollowupRUs.sav'.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_DrillTrhoughsupport'.
*spsstable='//covenas/decisionsupport/meinzer/projects/older adult/calendarTAYDrillTrhoughsupport.sav'.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_GoalsFY'.
*spsstable='//covenas/decisionsupport/meinzer/temp/MonthlygoalsMatched1TAY.sav'.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_GoalsMonthly'.
*spsstable=//covenas/decisionsupport/meinzer/temp/TAY_MainLineGraphs.sav.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_BarGraphFY'.
*spsstable='//covenas/decisionsupport/temp/bargraphtay.sav'.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_AdmitsDischarges'.
*spsstable='//covenas/decisionsupport/meinzer/temp/MonthlygoalsMatchedTAYc.sav'.
*pushbreak.
...
aggregate outfile='//covenas/decisionsupport/meinzer/temp/TAYGender.sav'
   ...
   /Clients=sum(counter).
*pushbreak.
*sqlTable = 'TAY_Demographics_Gender'.
*spsstable='//covenas/decisionsupport/meinzer/temp/TAYGender.sav'.
*pushbreak.
...
save outfile='//covenas/decisionsupport/meinzer/temp/TAYAgegroupShelledAGG.sav'.

*pushbreak.
*sqlTable = 'TAY_Demographics_Agegroup'.
*spsstable='//covenas/decisionsupport/meinzer/temp/TAYAgegroupShelledAGG.sav'.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_Demographics_Ethnicity'.
*spsstable=//covenas/decisionsupport/meinzer/temp/TAYEthnicityShelled.sav.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_NoLastSvc90RU'.
*spsstable=//covenas/decisionsupport/meinzer/temp/TAY_NoSvc90ru.sav.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_LastSvc90Clients'.
*spsstable=//covenas/decisionsupport/temp/clientlistTAY.sav.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_allSVCSforLastSvc90Clients'.
*spsstable='//covenas/decisionsupport/temp\TAYSvcs.sav'.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_EpsforLastSvc90Clients'.
*spsstable='//covenas/decisionsupport/temp\EpsTAY.sav'.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_TISListwithDX'.
*spsstable='//covenas/decisionsupport/temp/TISListwithDX.sav'.

*pushbreak.
*sqlTable = 'TAY_LOSListwithDX'.
*spsstable='//covenas/decisionsupport/temp/LOSListwithDX1.sav'.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_TIS'.
*spsstable='//covenas/decisionsupport/meinzer/temp/TISpastandpresentShellTAY.sav'.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_LOS'.
*spsstable='//covenas/decisionsupport/meinzer/temp/LOSShellTAY.sav'.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_ClientList_Eps'.
*spsstable='//covenas/decisionsupport/meinzer/temp/TAY_ClientListEps.sav'.
*pushbreak.
...
*pushbreak.
*sqlTable = 'TAY_ClientListSVC'.
*spsstable='//covenas/decisionsupport/meinzer/temp/TAY_ClientListSVC.sav'.
*pushbreak.
