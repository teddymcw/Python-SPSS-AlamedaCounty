...
with open('//covenas/decisionsupport/temp/programpush.sps','w') as programflowx:
    for item in pushList: 
        programflowx.write(item+ r'\n')

primaryFolder='//covenas/decisionsupport/temp/'
...
get file='//covenas/decisionsupport/dbsvcprogramflowsvconlypre.sav'.
...
get file='//covenas/decisionsupport/meinzer/temp/yearbeforework.sav' /keep case closdate
epflag
PrimaryTherapist
primdx
ru
...
with open('//covenas/decisionsupport/temp/programsytnax.sps','w') as programflowx:
    for item in pushList:
        programflowx.write(item+ r'\n')